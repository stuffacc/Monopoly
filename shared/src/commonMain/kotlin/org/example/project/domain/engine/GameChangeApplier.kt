...
object GameChangeApplier {
    fun applyGameChanges(gameState: GameState, gameChanges: List<GameChange>): GameState {
        return gameChanges.fold(initial = gameState) { lastGameState, gameChange ->
            when (gameChange) {
                ...
                is ChangeGameIsFinished -> changeGameIsFinishedGameChange(lastGameState, gameChange)
    ...
    private fun changeGameIsFinishedGameChange(gameState: GameState, gameChange: ChangeGameIsFinished): GameState {
        return gameState.copy(
            isFinished = gameChange.isFinished
        )
    }
